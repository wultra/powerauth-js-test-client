...
export interface ApplicationV15 {
    applicationId: string
    applicationRoles: string[]
}

export interface ApplicationVersionV15 {
...
export interface ApplicationDetail_Response {
    ...
    versions?: ApplicationVersionV15[]
}
...
export interface ApplicationVersionCreate_Response extends ApplicationVersionV15 {}
